# EDA Walmart Sales Data Analysis
...
The primary objective of this project is to extract valuable insights from Walmart's sales data, aiming to comprehend the various factors influencing the sales performance of its different branches.
...
For the rest of the code, check the [SQL_queries.sql](https://github.com/AGADA-BI/EDA_walmart_sales_analysis_with_SQL/blob/main/SQL_queries.sql) file
